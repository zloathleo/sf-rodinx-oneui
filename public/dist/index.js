...
exports.default = {
    ...
    Values: {
        Mock: false,
        // ServerUrl: '', 
        ServerUrl: 'http://192.168.2.70:80',
...
exports.default = {
    ...
    dataState: new _DataState2.default(),
    modalsState: new _ModalsState2.default(),
    uiState: new _UIState2.default()
};
...
(function (global, factory) {
	 true ? factory(exports, __webpack_require__(4), __webpack_require__(0), __webpack_require__(12)) :
...
exports.default = {
    ...
    requestServer: function requestServer(type, device, _then) {
        _MyFetch2.default.fetch(this.ip + '/server?type=' + type + '&device=' + device, { method: 'GET' }, _then);
    },

    requestPorts: function requestPorts(_then) {
        _MyFetch2.default.fetch(this.ip + '/ports', { method: 'GET' }, _then);
    },
    ...
    //更新Overview
    requestUpdateOverview: function requestUpdateOverview(obj, _then) {
        var form = new URLSearchParams();
        form.set('content', JSON.stringify(obj));
        _MyFetch2.default.fetch(this.ip + '/dashboard', { method: 'PUT', body: form }, _then);
    },

    //更改地址
    requestUpdateDeviceAddress: function requestUpdateDeviceAddress(deviceName, addr, dec1, dec2, _then) {
        var form = new URLSearchParams();
        form.set('addr', addr);
        form.set('d1', dec1);
        form.set('d2', dec2);
    ...
    //查询device detail
    requestDeviceDetail: function requestDeviceDetail(deviceName, _then) {
        _MyFetch2.default.fetch(this.ip + '/detail/' + deviceName, { method: 'GET' }, _then);
    },

    //查询device的settings
    requestDeviceSettings: function requestDeviceSettings(deviceName, type, source, _then) {
        _MyFetch2.default.fetch(this.ip + '/detail/' + deviceName + '/settings/' + type + '/' + source, { method: 'GET' }, _then);
    },

    //更新device的settings
    requestUpdateDeviceSettings: function requestUpdateDeviceSettings(deviceName, type, obj, _then) {
        var form = new URLSearchParams();
        form.set('content', JSON.stringify(obj));

        _MyFetch2.default.fetch(this.ip + '/detail/' + deviceName + '/settings/' + type, { method: 'PUT', body: form }, _then);
    },

    //查询模板
    requestTemplate: function requestTemplate(type, _then) {
        _MyFetch2.default.fetch(this.ip + '/templates/' + type, { method: 'GET' }, _then);
    },

    //下载通道配置模板
    requestDownloadTemplate: function requestDownloadTemplate(deviceName, ch, type) {
        _MyFetch2.default.downloadFile(this.ip + '/templates?device=' + deviceName + '&channel=' + ch + '&type=' + type);
    },

    //上传通道配置模板
    requestUpdateTemplate: function requestUpdateTemplate(deviceName, ch, _file, _then) {
...
exports.default = {
    ...
    renderText: function renderText(_status) {
        switch (_status) {
            case 0:
                {
                    //无火
...
var Switcher = function (_React$Component) {
    ...
    _createClass(Switcher, [{
        key: "onValueChange",
        value: function onValueChange(_event) {
            ...
            var func = this.props.valueChangeFunc;
            if (func) {
        ...
        key: "render",
        value: function render() {
            var items = this.props.items; //{display->value}
            var value = this.props.value;
            var width = this.props.width ? this.props.width : 100;
            if (items[0].value == value) {
                return _react2.default.createElement(
                    "div",
                    { className: "btn-group", "data-toggle": "buttons", onClick: this.onValueChange, style: this.props.style },
                    _react2.default.createElement(
                        "label",
                        { className: "btn btn-square btn-sm btn-primary", style: { width: '50%' } },
                        _react2.default.createElement("input", { type: "radio", defaultChecked: "true" }),
                        items[0].display
                    ),
                    _react2.default.createElement(
                        "label",
                        { className: "btn btn-square btn-sm btn-default", style: { width: '50%' } },
...
var _Scrollbars = __webpack_require__(45);
...
var toCamelCase = __webpack_require__(49)
var cache = { 'float': 'cssFloat' }
var addPxToStyle = __webpack_require__(52)
...
var BreadcrumbComponent = (0, _mobxReact.observer)(_class = function (_React$Component) {
    _inherits(BreadcrumbComponent, _React$Component);

    function BreadcrumbComponent(props) {
        _classCallCheck(this, BreadcrumbComponent);

        return _possibleConstructorReturn(this, (BreadcrumbComponent.__proto__ || Object.getPrototypeOf(BreadcrumbComponent)).call(this, props));
    }

    _createClass(BreadcrumbComponent, [{
        key: 'onClickModuleLink',
        value: function onClickModuleLink() {
            _StateManager2.default.dataState.resetDetailJson();
            _StateManager2.default.appState.resetModuleRoot();
        }
    }, {
        key: 'onClickLevel1Link',
        value: function onClickLevel1Link() {
            _StateManager2.default.appState.setActiveModuleLevel2Name(undefined);
        }
    }, {
        key: 'render',
        value: function render() {
            if (_StateManager2.default.appState.activeModuleLevel1Name != undefined) {
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _StateManager2.default.appState.activeMainModule
                            )
                        ),
                        _react2.default.createElement(
                            'li',
                            ...
                            _react2.default.createElement(
                                'a',
                                { className: 'link-effect', href: '#', onClick: this.onClickLevel1Link.bind(this) },
                                _StateManager2.default.dataState.device
                            )
                        ),
                        _react2.default.createElement(
                            'li',
                            null,
                            _StateManager2.default.appState.activeModuleLevel2Name
                        )
                    );
                } else {
                    return _react2.default.createElement(
...
var EnableSwitcher = function (_Switcher) {
    _inherits(EnableSwitcher, _Switcher);

    function EnableSwitcher() {
        _classCallCheck(this, EnableSwitcher);

        return _possibleConstructorReturn(this, (EnableSwitcher.__proto__ || Object.getPrototypeOf(EnableSwitcher)).apply(this, arguments));
    }

    _createClass(EnableSwitcher, [{
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        key: '_init_config',
        value: function _init_config() {
            if (_Constants2.default.Values.Mock) {
                //模拟数据开关
        ...
        key: 'render',
        value: function render() {
            return _react2.default.createElement(_PageContainerComponent2.default, null);
        }
    }]);
...
exports.default = {
    init: function init() {
        _fetchMock2.default.get('/server?type=1&device=A0', _mockjs2.default.mock({
        ...
        _fetchMock2.default.get('/ports', _mockjs2.default.mock({
            'rows|2-8': ['COM3']
        }));

        //更新dashboard
        _fetchMock2.default.put('/dashboard', _mockjs2.default.mock({
            "server_time": "2017-07-01 12:00:00"
        }));
        ...
        _fetchMock2.default.get('/detail/A1', _mockjs2.default.mock({
            "addr": 1,
            "name": "A1",
            "ch1": {
                "ac": 0,
        ...
        var _settings = _mockjs2.default.mock({
            "addr": 1,
            "ch1": {
                "ao_value": {
                    "ao_20ma_value": 65295,
                ...
                "filea": {
                    "ac": {
                        ...
                        "r_d": 0.02,
                        "r_weight": 0.333,
                        "weight_h": [0.575, 0.225, 0.1, 0.1],
                        "weight_l": [0.1, 0.5, 0.2, 0.2],
                        "weight_n": [0.05, 0.2, 0.2, 0.55],
                        "weight_ph": 150,
                        "weight_pl": 100
                    },
                    "dc": {
        ...
        _fetchMock2.default.get('/detail/A1/settings/u/m', _settings);

        _fetchMock2.default.get('/detail/A1/settings/s/m', _settings);

        //修改device地址
        _fetchMock2.default.patch('/dashboard/A1', _mockjs2.default.mock({
            "server_time": "2017-07-01 12:00:00"
        }));

        //更新settings
        _fetchMock2.default.put('/detail/A1/settings/u', _mockjs2.default.mock({
            "server_time": "2017-07-01 12:00:00"
        }));

        //更新settings
        _fetchMock2.default.put('/detail/A1/settings/s', _mockjs2.default.mock({
            "server_time": "2017-07-01 12:00:00"
        }));

        //保存通道配置模板
        _fetchMock2.default.post('/templates/aaa', _mockjs2.default.mock({
            "server_time": "2017-07-01 12:00:00"
        }));

        //查询模板
        _fetchMock2.default.get('/templates/u', _mockjs2.default.mock({
            "rows": ["A1T1", "A2T2", "A3T1", "A4T4"]
        }));

        //应用通道配置模板
        _fetchMock2.default.put('/templates/aaa', _mockjs2.default.mock({
            "server_time": "2017-07-01 12:00:00"
        }));

        //登录
        _fetchMock2.default.patch('/users/admin', _mockjs2.default.mock({
            "server_time": "2017-07-01 12:00:00",
...
var _ItemComponent = __webpack_require__(64);

var _ItemComponent2 = _interopRequireDefault(_ItemComponent);

var _DeviceDetailComponent = __webpack_require__(65);
...
var LayoutConfigModalContent = function (_React$Component) {
    ...
    function LayoutConfigModalContent() {
        _classCallCheck(this, LayoutConfigModalContent);

        return _possibleConstructorReturn(this, (LayoutConfigModalContent.__proto__ || Object.getPrototypeOf(LayoutConfigModalContent)).apply(this, arguments));
    }
...
var AppendButtonPanel = function (_React$Component2) {
    _inherits(AppendButtonPanel, _React$Component2);
...
var OverviewTopComponent = function (_React$Component4) {
    ...
    _createClass(OverviewTopComponent, [{
        ...
        value: function updateCurrentOverview() {
            _StateManager2.default.appState.setMainLoading(true);
...
var OverviewComponent = (0, _mobxReact.observer)(_class = function (_React$Component5) {
    ...
    _createClass(OverviewComponent, [{
        ...
        value: function render() {
            if (_StateManager2.default.appState.activeModuleLevel1Name == undefined) {
                return _react2.default.createElement(OverviewTopComponent, null);
            } else if (_StateManager2.default.appState.activeModuleLevel1Name == _Constants2.default.Values.Overview_Level1_Detail) {
                return _react2.default.createElement(_DeviceDetailComponent2.default, null);
            }
        }
    }]);
...
var _raf2 = __webpack_require__(46);
...
var _returnFalse = __webpack_require__(59);

var _returnFalse2 = _interopRequireDefault(_returnFalse);

var _getInnerWidth = __webpack_require__(60);

var _getInnerWidth2 = _interopRequireDefault(_getInnerWidth);

var _getInnerHeight = __webpack_require__(61);

var _getInnerHeight2 = _interopRequireDefault(_getInnerHeight);

var _styles = __webpack_require__(62);

var _defaultRenderElements = __webpack_require__(63);
...
var space = __webpack_require__(50)
...
var clean = __webpack_require__(51)
...
var ItemComponent = (0, _mobxReact.observer)(_class = function (_React$Component2) {
    _inherits(ItemComponent, _React$Component2);
    ...
    _createClass(ItemComponent, [{
        ...
        key: 'onClickItem',
        value: function onClickItem(_item) {
            console.log('_item:', _item);
            if (_item.addr != -1) {
                _StateManager2.default.appState.setMainLoading(true);
                _OverviewService2.default.requestDeviceDetail(_item.name, function (json) {
                    _StateManager2.default.dataState.device = _item.name;
                    _StateManager2.default.dataState.detailJson = json;
                    _StateManager2.default.appState.setActiveModuleLevel1Name(_Constants2.default.Values.Overview_Level1_Detail);
                    _StateManager2.default.appState.setMainLoading(false);
                }.bind(this));
            } else {
        ...
        value: function render() {
            ...
            if (rtJson) {
                ...
                if (_status_values) {
                    ...
                    color1 = _Utils2.default.renderColor(_status1);
            ...
            if (_isLast) {
                optionsHtml = _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'button',
                            { type: 'button', onClick: this.onClickRemoveItem.bind(this, _item), 'data-toggle': 'modal', 'data-target': '#modal-fromleft' },
            ...
            var _row = _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'col-xs-6', style: { padding: '0', textAlign: 'center' } },
                    _react2.default.createElement('i', { className: 'glyphicon glyphicon-fire', style: { fontSize: '1.6em', color: color1 } }),
                    _react2.default.createElement(
                        'div',
                        { className: 'font-w400', style: { paddingLeft: '3px' } },
                        'CH1'
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'col-xs-6', style: { padding: '0', textAlign: 'center' } },
                    _react2.default.createElement('i', { className: 'glyphicon glyphicon-fire', style: { fontSize: '1.6em', color: color2 } }),
                    _react2.default.createElement(
                        'div',
                        { className: 'font-w400', style: { paddingLeft: '3px' } },
                        'CH2'
            ...
            if (_item.addr == -1) {
                _content = _react2.default.createElement(
                    'div',
                    { className: 'block-content', style: { margin: '1px', padding: '8px 20px 5px', cursor: 'pointer' }, 'data-toggle': 'modal', 'data-target': '#modal-fromleft', onClick: this.onClickItem.bind(this, _item) },
                    _row
                );
            } else {
                _content = _react2.default.createElement(
                    'div',
                    { className: 'block-content', style: { margin: '1px', padding: '8px 20px 5px', cursor: 'pointer' }, onClick: this.onClickItem.bind(this, _item) },
                    _row
                );
            }
            ...
            return _react2.default.createElement(
                'div',
                { className: 'col-xs-6 col-sm-2', style: { padding: '3px' } },
                _react2.default.createElement(
                    'a',
                    { className: 'block block-link-hover2 block-bordered', style: { marginBottom: '0px' } },
                    _react2.default.createElement(
                        'div',
...
var _DeviceUserSettingsComponent = __webpack_require__(66);

var _DeviceUserSettingsComponent2 = _interopRequireDefault(_DeviceUserSettingsComponent);

var _DeviceFactorySettingsComponent = __webpack_require__(67);
...
//设备详情
var Descript = function (_React$Component) {
    _inherits(Descript, _React$Component);

    function Descript() {
        _classCallCheck(this, Descript);

        return _possibleConstructorReturn(this, (Descript.__proto__ || Object.getPrototypeOf(Descript)).apply(this, arguments));
    }

    _createClass(Descript, [{
        key: 'render',
        value: function render() {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'ul',
                                    { className: 'list-unstyled weather-info' },
                                    _react2.default.createElement(
                                        'li',
                                        null,
                                        _react2.default.createElement(
...
var CHDetailTempTr = (0, _mobxReact.observer)(_class = function (_React$Component2) {
    _inherits(CHDetailTempTr, _React$Component2);

    function CHDetailTempTr() {
        _classCallCheck(this, CHDetailTempTr);

        return _possibleConstructorReturn(this, (CHDetailTempTr.__proto__ || Object.getPrototypeOf(CHDetailTempTr)).apply(this, arguments));
    }

    _createClass(CHDetailTempTr, [{
        key: 'render',
        value: function render() {
            var _value = this.props.value;
            if (_StateManager2.default.uiState.tempUnit == 'C') {
                _value = this.props.value;
            } else {
                _value = this.props.value * 1.8 + 32;
            }

            var _status = this.props.status;
            if (_status == 3) {
                return _react2.default.createElement(
                    'tr',
                    null,
                    ...
                    _react2.default.createElement(
                        'td',
                        { className: 'text-right font-w600 font-ds-digital-s20' },
                        _react2.default.createElement(
                            'del',
                            null,
                            _value
    ...
    return CHDetailTempTr;
}(_react2.default.Component)) || _class;

var CHDetailTr = function (_React$Component3) {
    _inherits(CHDetailTr, _React$Component3);

    function CHDetailTr() {
        _classCallCheck(this, CHDetailTr);

        return _possibleConstructorReturn(this, (CHDetailTr.__proto__ || Object.getPrototypeOf(CHDetailTr)).apply(this, arguments));
    }

    _createClass(CHDetailTr, [{
        key: 'render',
        value: function render() {
            var _status = this.props.status;
            if (_status == 3) {
...
var CHDetail = (0, _mobxReact.observer)(_class2 = function (_React$Component4) {
    _inherits(CHDetail, _React$Component4);

    function CHDetail() {
        _classCallCheck(this, CHDetail);

        return _possibleConstructorReturn(this, (CHDetail.__proto__ || Object.getPrototypeOf(CHDetail)).apply(this, arguments));
    }

    _createClass(CHDetail, [{
        key: 'render',
        value: function render() {
            var _chdata = undefined;

            var deviceJson = _StateManager2.default.dataState.detailJson;
            if (deviceJson) {
            ...
            var _status = _chdata.status;
            var _color = _Utils2.default.renderColor(_status);
            var _text = _Utils2.default.renderText(_status);

            return _react2.default.createElement(
                'div',
                { className: 'col-xs-12 col-sm-6', style: { padding: '0px 3px' } },
                _react2.default.createElement(
                    'div',
                    { className: 'block block-bordered end-block-margin-bottom' },
                    _react2.default.createElement(
                        'div',
                        { className: 'block-header bg-gray-lighter main-content-item-header' },
                        _react2.default.createElement(
                            'ul',
                            { className: 'block-options' },
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'span',
                                    { className: 'label', style: { backgroundColor: _color } },
                                    _text
                                )
                            )
                        ),
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'table',
                            { className: 'table table-borderless table-condensed table-vcenter font-s13' },
                            _react2.default.createElement(
                                'tbody',
                                null,
                                _react2.default.createElement(CHDetailTr, { field: 'FILE', value: _chdata.file == 0 ? 'File A' : 'File B', status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'ON_TH', value: _chdata.onth, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'ON_TL', value: _chdata.ontl, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'MAX', value: _chdata.max, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'MIN', value: _chdata.min, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'DC', value: _chdata.dc, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'AC', value: _chdata.ac, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'FREQ', value: _chdata.freq, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'TYPE', value: _chdata.type, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'STATUS', value: _chdata.status, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'FAULT', value: _chdata.fault, status: _status }),
                                _react2.default.createElement(CHDetailTempTr, { field: 'TEMP', value: _chdata.temp, status: _status }),
                                _react2.default.createElement(CHDetailTr, { field: 'FQ', value: _chdata.fq, status: _status })
                            )
                        )
                    )
                )
...
var DeviceContentComponent = (0, _mobxReact.observer)(_class3 = function (_React$Component5) {
    _inherits(DeviceContentComponent, _React$Component5);

    function DeviceContentComponent(props) {
        _classCallCheck(this, DeviceContentComponent);

        var _this5 = _possibleConstructorReturn(this, (DeviceContentComponent.__proto__ || Object.getPrototypeOf(DeviceContentComponent)).call(this, props));

        _this5.settingsData = undefined;
        _this5.onClickUserSettingsButton = _this5.onClickUserSettingsButton.bind(_this5);
        _this5.onClickFactorySettingsButton = _this5.onClickFactorySettingsButton.bind(_this5);
        _this5.unitSwitcherChange = _this5.unitSwitcherChange.bind(_this5);
        _this5.onClickSaveSettings = _this5.onClickSaveSettings.bind(_this5);
        return _this5;
    }
    ...
    _createClass(DeviceContentComponent, [{
        key: 'onClickSaveSettings',
        value: function onClickSaveSettings() {
            if (_StateManager2.default.appState.activeModuleLevel2Name == _Constants2.default.Values.Overview_Level2_UserSettings) {
                this.userSettingsComponent.mergeData();
                console.log(JSON.stringify(this.settingsData));
                _OverviewService2.default.requestUpdateDeviceSettings(_StateManager2.default.dataState.device, 'u', this.settingsData, function (json) {});
            } else if (_StateManager2.default.appState.activeModuleLevel2Name == _Constants2.default.Values.Overview_Level2_FactorySettings) {
                _OverviewService2.default.requestUpdateDeviceSettings(_StateManager2.default.dataState.device, 's', this.settingsData, function (json) {});
            }
        }
    }, {
        key: 'onClickUserSettingsButton',
        value: function onClickUserSettingsButton() {
            _StateManager2.default.appState.setMainLoading(true);
            _OverviewService2.default.requestDeviceSettings(_StateManager2.default.dataState.device, 'u', 'm', function (json) {
                this.settingsData = json;
                _StateManager2.default.appState.setMainLoading(false);
                _StateManager2.default.appState.setActiveModuleLevel2Name(_Constants2.default.Values.Overview_Level2_UserSettings);
            }.bind(this));
        }
    }, {
        key: 'onClickFactorySettingsButton',
        value: function onClickFactorySettingsButton() {
            _StateManager2.default.appState.setMainLoading(true);
            _OverviewService2.default.requestDeviceSettings(_StateManager2.default.dataState.device, 's', 'm', function (json) {
                this.settingsData = json;
                _StateManager2.default.appState.setMainLoading(false);
                _StateManager2.default.appState.setActiveModuleLevel2Name(_Constants2.default.Values.Overview_Level2_FactorySettings);
            }.bind(this));
        }
    }, {
        ...
        value: function unitSwitcherChange(selectedItem) {
            //第一选项是否选中 即摄氏度是否选中  
            _StateManager2.default.uiState.setTempUnit(selectedItem);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            if (_StateManager2.default.appState.activeModuleLevel2Name == _Constants2.default.Values.Overview_Level2_UserSettings) {
                return _react2.default.createElement(_DeviceUserSettingsComponent2.default, { ref: function ref(_ref) {
                        return _this6.userSettingsComponent = _ref;
                    }, data: this.settingsData });
            } else if (_StateManager2.default.appState.activeModuleLevel2Name == _Constants2.default.Values.Overview_Level2_FactorySettings) {
                return _react2.default.createElement(_DeviceFactorySettingsComponent2.default, { ref: function ref(_ref) {
                        return _this6.factorySettingsComponent = _ref;
                    }, data: this.settingsData });
            } else {
                return _react2.default.createElement(
                    'div',
                    { className: 'row animated bounceIn main-detail-padding-margin' },
                    _react2.default.createElement(CHDetail, { name: 'CH1' }),
                    _react2.default.createElement(CHDetail, { name: 'CH2' }),
                    _react2.default.createElement(Descript, { parent: this })
                );
            }
        }
    }]);

    return DeviceContentComponent;
}(_react2.default.Component)) || _class3;

var ButtonGroup = (0, _mobxReact.observer)(_class4 = function (_React$Component6) {
    _inherits(ButtonGroup, _React$Component6);
        ...
        value: function render() {
            ...
            if (_StateManager2.default.appState.activeModuleLevel2Name == _Constants2.default.Values.Overview_Level2_UserSettings) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-square btn-sm btn-primary', onClick: _parent.onClickSaveSettings, style: { margin: '0 2px 0 0' } },
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-square btn-sm btn-danger', onClick: _parent.onClickSaveSettings, style: { margin: '0 2px 0 0' } },
                        _react2.default.createElement('i', { className: 'fa fa-check' }),
                        ' ',
                        _react2.default.createElement(
                            'span',
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-square btn-sm btn-danger', onClick: _parent.onClickFactorySettingsDelegate, style: { margin: '0 2px 0 0' } },
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-square btn-sm btn-primary', onClick: _parent.onClickUserSettingsDelegate, style: { margin: '0 2px 0 0' } },
                        _react2.default.createElement('i', { className: 'glyphicon glyphicon-cog' }),
                        ' ',
                        _react2.default.createElement(
                            'span',
...
var DeviceDetailComponent = function (_React$Component7) {
    _inherits(DeviceDetailComponent, _React$Component7);

    function DeviceDetailComponent(props) {
        _classCallCheck(this, DeviceDetailComponent);

        var _this8 = _possibleConstructorReturn(this, (DeviceDetailComponent.__proto__ || Object.getPrototypeOf(DeviceDetailComponent)).call(this, props));

        _this8.onClickUserSettingsDelegate = _this8.onClickUserSettingsDelegate.bind(_this8);
        _this8.onClickFactorySettingsDelegate = _this8.onClickFactorySettingsDelegate.bind(_this8);
        _this8.onClickSaveSettings = _this8.onClickSaveSettings.bind(_this8);
        return _this8;
    }
    ...
    _createClass(DeviceDetailComponent, [{
        key: 'onClickSaveSettings',
        value: function onClickSaveSettings() {
            this.deviceContentComponent.onClickSaveSettings();
        }
    }, {
        key: 'onClickFactorySettingsDelegate',
        value: function onClickFactorySettingsDelegate() {
            this.deviceContentComponent.onClickFactorySettingsButton();
        }
    }, {
        key: 'onClickUserSettingsDelegate',
        value: function onClickUserSettingsDelegate() {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'block-header bg-gray-lighter overview-head-padding' },
                    _react2.default.createElement(ButtonGroup, { parent: this }),
                    _react2.default.createElement(_BreadcrumbComponent2.default, null)
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'block-content main-content-padding' },
                    _react2.default.createElement(
                        _reactCustomScrollbars.Scrollbars,
                        { style: { height: _StateManager2.default.uiState.OverviewTopContentHeight } },
                        _react2.default.createElement(DeviceContentComponent, { ref: function ref(_ref) {
                                return _this9.deviceContentComponent = _ref;
                            } })
                    )
                )
            );
...
var DeviceCHSettings = function (_React$Component4) {
    ...
    _createClass(DeviceCHSettings, [{
        ...
        value: function onClickSaveTemplateButton() {
            _OverviewService2.default.requestDownloadTemplate(_StateManager2.default.dataState.device, this.props.name, 'u');
        ...
        value: function onClickUseTemplateButton() {
            ...
            _StateManager2.default.modalsState.setModal('Template Choose', _react2.default.createElement(TemplateUseModalContent, { ref: function ref(_ref) {
                    return _this8.modalContent = _ref;
                } }), function () {

                var _files = this.modalContent.inputFilePath.files;
                if (_files) {
                    var _selectedFile = _files[0];
                    console.log(_selectedFile);

                    _OverviewService2.default.requestUpdateTemplate(_StateManager2.default.dataState.device, this.props.name, _selectedFile, function (json) {
                        console.log('ok:', json);
                    }.bind(this));
                }
            }.bind(this));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'table',
                            { className: 'table table-striped table-vcenter table-header-bg' },
                            _react2.default.createElement(
                                'thead',
                                null,
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'th',
                                        { className: 'text-center', style: { width: '40%', padding: '3px' } },
                                        'Name'
                                    ),
                                    _react2.default.createElement(
                                        'th',
                                        { className: 'text-center', style: { width: '30%', padding: '3px' } },
                                        'FileA'
                                    ),
                                    _react2.default.createElement(
                                        'th',
...
var DeviceUserSettingsComponent = function (_React$Component5) {
    ...
    function DeviceUserSettingsComponent(props) {
        ...
        _this10.mergeData = _this10.mergeData.bind(_this10);
        return _this10;
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(DeviceCHSettings, { ref: function ref(_ref) {
                        return _this11.ch1SettingsPanel = _ref;
                    }, name: 'CH1', data: _data.ch1 }),
                _react2.default.createElement(DeviceCHSettings, { ref: function ref(_ref) {
                        return _this11.ch2SettingsPanel = _ref;
                    }, name: 'CH2', data: _data.ch2 })
            );
        }
    }]);
...
var _VersionInfo = __webpack_require__(68);

var _VersionInfo2 = _interopRequireDefault(_VersionInfo);

var _CheckEnables = __webpack_require__(69);

var _CheckEnables2 = _interopRequireDefault(_CheckEnables);

var _ChannelsInfo = __webpack_require__(70);
...
var DeviceFactorySettingsComponent = function (_React$Component) {
    ...
    function DeviceFactorySettingsComponent(props) {
        ...
        return _possibleConstructorReturn(this, (DeviceFactorySettingsComponent.__proto__ || Object.getPrototypeOf(DeviceFactorySettingsComponent)).call(this, props));
    }
...
var VersionLeftItem = function (_React$Component) {
    _inherits(VersionLeftItem, _React$Component);

    function VersionLeftItem() {
        _classCallCheck(this, VersionLeftItem);

        return _possibleConstructorReturn(this, (VersionLeftItem.__proto__ || Object.getPrototypeOf(VersionLeftItem)).apply(this, arguments));
    }

    _createClass(VersionLeftItem, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'col-xs-6 col-sm-3', style: { display: 'flex', alignItems: 'center', padding: '0px 5px 0px 0px' } },
                _react2.default.createElement(
                    'span',
                    { style: { width: '160%' } },
                    this.props.label
                ),
                _react2.default.createElement('input', { type: 'text', className: 'form-control input-sm font-ds-digital-s20', size: '6', defaultValue: this.props.defaultValue })
            );
        }
    }]);

    return VersionLeftItem;
}(_react2.default.Component);

var VersionRightItem = function (_React$Component2) {
    _inherits(VersionRightItem, _React$Component2);

    function VersionRightItem() {
        _classCallCheck(this, VersionRightItem);

        return _possibleConstructorReturn(this, (VersionRightItem.__proto__ || Object.getPrototypeOf(VersionRightItem)).apply(this, arguments));
    }

    _createClass(VersionRightItem, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'col-xs-6 col-sm-3', style: { display: 'flex', alignItems: 'center', padding: '0px 0px 0px 0px' } },
                _react2.default.createElement(
                    'span',
                    { style: { width: '160%' } },
                    this.props.label
    ...
    return VersionRightItem;
}(_react2.default.Component);

var VersionInfo = function (_React$Component3) {
    _inherits(VersionInfo, _React$Component3);
    ...
    _createClass(VersionInfo, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'block-content', style: { padding: '10px' } },
                    _react2.default.createElement(
                        'div',
                        { className: 'row', style: { margin: '1px' } },
                        _react2.default.createElement(VersionLeftItem, { label: 'AMP Version', defaultValue: _data.amp_version }),
                        _react2.default.createElement(VersionRightItem, { label: 'FW Version', defaultValue: _data.fw_version }),
                        _react2.default.createElement(VersionLeftItem, { label: 'CH1', defaultValue: _data.ch1 }),
                        _react2.default.createElement(VersionRightItem, { label: 'CH2', defaultValue: _data.ch2 })
                    )
                )
            );
        }
...
var Item = function (_React$Component) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'col-xs-12 col-sm-3', style: { display: 'flex', alignItems: 'center', padding: '0px 0px' } },
                _react2.default.createElement(
                    'span',
                    { style: { width: '50%' } },
                    this.props.label
                ),
                _react2.default.createElement(_EnableSwitcher2.default, { style: { width: '100%' }, value: this.props.defaultValue })
            );
        }
    }]);
...
var CheckEnables = function (_React$Component2) {
    _inherits(CheckEnables, _React$Component2);

    function CheckEnables() {
        _classCallCheck(this, CheckEnables);

        return _possibleConstructorReturn(this, (CheckEnables.__proto__ || Object.getPrototypeOf(CheckEnables)).apply(this, arguments));
    }

    _createClass(CheckEnables, [{
        key: 'render',
        value: function render() {
            var _data = this.props.data;
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'row', style: { margin: '1px' } },
                        _react2.default.createElement(Item, { label: 'Scan1', defaultValue: _data.scan1 }),
                        _react2.default.createElement(Item, { label: 'Scan2', defaultValue: _data.scan2 }),
                        _react2.default.createElement(Item, { label: 'T1', defaultValue: _data.t1 }),
                        _react2.default.createElement(Item, { label: 'T2', defaultValue: _data.t2 }),
                        _react2.default.createElement(Item, { label: 'DA1', defaultValue: _data.da1 }),
                        _react2.default.createElement(Item, { label: 'DA2', defaultValue: _data.da2 }),
                        _react2.default.createElement(Item, { label: 'FRAM', defaultValue: _data.fram })
                    )
                )
            );
        }
...
var FourSettingItem = function (_React$Component) {
    _inherits(FourSettingItem, _React$Component);

    function FourSettingItem() {
        _classCallCheck(this, FourSettingItem);

        return _possibleConstructorReturn(this, (FourSettingItem.__proto__ || Object.getPrototypeOf(FourSettingItem)).apply(this, arguments));
    }

    _createClass(FourSettingItem, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "tr",
                ...
                _react2.default.createElement(
                    "td",
                    { className: "text-right setting-table-item-label-padding" },
                    this.props.label
                ),
                _react2.default.createElement(
                    "td",
                    { className: "text-center setting-table-item-padding" },
                    _react2.default.createElement("input", { className: "form-control input-sm font-ds-digital-s20", type: "text", defaultValue: this.props.v1 })
                ),
                _react2.default.createElement(
                    "td",
                    { className: "text-center setting-table-item-padding" },
                    _react2.default.createElement("input", { className: "form-control input-sm font-ds-digital-s20", type: "text", defaultValue: this.props.v2 })
                ),
                _react2.default.createElement(
                    "td",
                    { className: "text-center setting-table-item-padding" },
                    _react2.default.createElement("input", { className: "form-control input-sm font-ds-digital-s20", type: "text", defaultValue: this.props.v3 })
                ),
                _react2.default.createElement(
                    "td",
                    { className: "text-center setting-table-item-padding" },
                    _react2.default.createElement("input", { className: "form-control input-sm font-ds-digital-s20", type: "text", defaultValue: this.props.v4 })
                )
            );
        }
    }]);

    return FourSettingItem;
}(_react2.default.Component);

var TwoSettingItem = function (_React$Component2) {
    _inherits(TwoSettingItem, _React$Component2);

    function TwoSettingItem() {
        _classCallCheck(this, TwoSettingItem);

        return _possibleConstructorReturn(this, (TwoSettingItem.__proto__ || Object.getPrototypeOf(TwoSettingItem)).apply(this, arguments));
    }

    _createClass(TwoSettingItem, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "tr",
                ...
                _react2.default.createElement(
                    "td",
                    { className: "text-right setting-table-item-label-padding", style: { width: '25%' } },
                    this.props.label1
                ),
                _react2.default.createElement(
                    "td",
                    { className: "text-center setting-table-item-padding", style: { width: '25%' } },
                    _react2.default.createElement("input", { className: "form-control input-sm font-ds-digital-s20", type: "text", defaultValue: this.props.v1 })
                ),
                _react2.default.createElement(
                    "td",
    ...
    return TwoSettingItem;
}(_react2.default.Component);

var TwoSettingNullItem = function (_React$Component3) {
    _inherits(TwoSettingNullItem, _React$Component3);

    function TwoSettingNullItem() {
        _classCallCheck(this, TwoSettingNullItem);

        return _possibleConstructorReturn(this, (TwoSettingNullItem.__proto__ || Object.getPrototypeOf(TwoSettingNullItem)).apply(this, arguments));
    }

    _createClass(TwoSettingNullItem, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "tr",
                { className: "hidden-xs" },
                _react2.default.createElement("td", { style: { width: '25%' } }),
                _react2.default.createElement(
                    "td",
                    { className: "text-center setting-table-item-padding", style: { width: '25%' } },
                    _react2.default.createElement("input", { style: { visibility: 'hidden' }, className: "form-control input-sm font-ds-digital-s20", type: "text" })
                ),
                _react2.default.createElement(
                    "td",
                    { style: { width: '25%' } },
    ...
    return TwoSettingNullItem;
}(_react2.default.Component);

var ACPanel = function (_React$Component4) {
    _inherits(ACPanel, _React$Component4);

    function ACPanel() {
        _classCallCheck(this, ACPanel);

        return _possibleConstructorReturn(this, (ACPanel.__proto__ || Object.getPrototypeOf(ACPanel)).apply(this, arguments));
    }

    _createClass(ACPanel, [{
        key: "render",
        value: function render() {
            var _data = this.props.data;
            return _react2.default.createElement(
                "div",
                { className: "bs-callout bs-callout-primary" },
                _react2.default.createElement(
                    "h4",
                    null,
                    "AC"
                ...
                _react2.default.createElement(
                    "table",
                    { className: "table table-striped table-vcenter table-header-bg", style: { marginBottom: '10px' } },
                    _react2.default.createElement(
                        "tbody",
                        null,
                        _react2.default.createElement(TwoSettingItem, { label1: "l_band", label2: "r_band", v1: _data.l_band, v2: _data.r_band }),
                        _react2.default.createElement(TwoSettingItem, { label1: "l_weight", label2: "r_weight", v1: _data.l_weight, v2: _data.r_weight }),
                        _react2.default.createElement(TwoSettingItem, { label1: "l_d", label2: "r_d", v1: _data.l_d, v2: _data.r_d }),
                        _react2.default.createElement(TwoSettingItem, { label1: "weight_pL", label2: "weight_pH", v1: _data.weight_pl, v2: _data.weight_ph }),
                        _react2.default.createElement(TwoSettingItem, { label1: "line_turn", label2: "line_param", v1: _data.line_turn, v2: _data.line_param })
                    )
                ),
                _react2.default.createElement(
                    "table",
                    { className: "table table-striped table-vcenter table-header-bg", style: { marginBottom: 0 } },
                    _react2.default.createElement(
                        "tbody",
                        null,
                        _react2.default.createElement(FourSettingItem, { label: "weight.N", v1: _data.weight_n[0], v2: _data.weight_n[1], v3: _data.weight_n[2], v4: _data.weight_n[3] }),
                        _react2.default.createElement(FourSettingItem, { label: "weight.L", v1: _data.weight_l[0], v2: _data.weight_l[1], v3: _data.weight_l[2], v4: _data.weight_l[3] }),
                        _react2.default.createElement(FourSettingItem, { label: "weight.H", v1: _data.weight_h[0], v2: _data.weight_h[1], v3: _data.weight_h[2], v4: _data.weight_h[3] })
                    )
                )
            );
        }
...
var DCPanel = function (_React$Component5) {
    _inherits(DCPanel, _React$Component5);

    function DCPanel() {
        _classCallCheck(this, DCPanel);

        return _possibleConstructorReturn(this, (DCPanel.__proto__ || Object.getPrototypeOf(DCPanel)).apply(this, arguments));
    }

    _createClass(DCPanel, [{
        key: "render",
        value: function render() {
            var _data = this.props.data;
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "tbody",
                        null,
                        _react2.default.createElement(TwoSettingNullItem, null),
                        _react2.default.createElement(TwoSettingNullItem, null),
                        _react2.default.createElement(TwoSettingNullItem, null),
                        _react2.default.createElement(TwoSettingItem, { label1: "weight_pL", label2: "weight_pH", v1: _data.weight_pl, v2: _data.weight_ph }),
                        _react2.default.createElement(TwoSettingNullItem, null)
...
var FrequencyPanel = function (_React$Component6) {
    _inherits(FrequencyPanel, _React$Component6);

    function FrequencyPanel() {
        _classCallCheck(this, FrequencyPanel);

        return _possibleConstructorReturn(this, (FrequencyPanel.__proto__ || Object.getPrototypeOf(FrequencyPanel)).apply(this, arguments));
    }

    _createClass(FrequencyPanel, [{
        key: "render",
        value: function render() {
            var _data = this.props.data;
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "tbody",
                        null,
                        _react2.default.createElement(TwoSettingItem, { label1: "raise_v1", label2: "drop_v1", v1: _data.raise_v1, v2: _data.drop_v1 }),
                        _react2.default.createElement(TwoSettingItem, { label1: "raise_v2", label2: "drop_v2", v1: _data.raise_v2, v2: _data.drop_v2 }),
                        _react2.default.createElement(TwoSettingItem, { label1: "raise_num", label2: "drop_num", v1: _data.raise_num, v2: _data.drop_num }),
                        _react2.default.createElement(TwoSettingItem, { label1: "weight_pL", label2: "weight_pH", v1: _data.weight_pl, v2: _data.weight_ph }),
                        _react2.default.createElement(TwoSettingNullItem, null)
                    )
                ),
...
var FilePanel = function (_React$Component7) {
    _inherits(FilePanel, _React$Component7);

    function FilePanel() {
        _classCallCheck(this, FilePanel);

        return _possibleConstructorReturn(this, (FilePanel.__proto__ || Object.getPrototypeOf(FilePanel)).apply(this, arguments));
    }
    ...
    _createClass(FilePanel, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "col-xs-12 col-sm-4 factory-settings-file-info-panel" },
                    _react2.default.createElement(ACPanel, { data: _data.ac })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "col-xs-12 col-sm-4 factory-settings-file-info-panel" },
                    _react2.default.createElement(DCPanel, { data: _data.dc })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "col-xs-12 col-sm-4 factory-settings-file-info-panel" },
                    _react2.default.createElement(FrequencyPanel, { data: _data.frequency })
                )
            );
        }
    }]);
...
var Channel = function (_React$Component8) {
    _inherits(Channel, _React$Component8);
    ...
    _createClass(Channel, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "col-xs-6", style: { display: 'flex', alignItems: 'center', padding: '0px 0px 5px' } },
                    _react2.default.createElement(
                        "span",
                        null,
                        "ao_4mA_Value"
                    ...
                    "  ",
                    _react2.default.createElement("input", { className: "form-control input-sm push-5-l push-5-r font-ds-digital-s20", type: "text", size: "6", defaultValue: _data.ao_value.ao_4ma_value })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "col-xs-6", style: { display: 'flex', alignItems: 'center', padding: '0px 0px 5px' } },
                    ...
                    "  ",
                    _react2.default.createElement("input", { className: "form-control input-sm push-5-l font-ds-digital-s20", type: "text", size: "6", defaultValue: _data.ao_value.ao_20ma_value })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "col-xs-12", style: { margin: '1px', padding: '0px' } },
                    _react2.default.createElement(
                        "div",
                        { className: "block end-block-margin-bottom" },
                        _react2.default.createElement(
                            "ul",
                            { className: "nav nav-pills", "data-toggle": "tabs" },
                            _react2.default.createElement(
                                "li",
                                { className: "active" },
                                _react2.default.createElement(
                                    "a",
                                    { "data-toggle": "tab", href: "#filea" },
                                    "File A"
                                )
                            ),
                            _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "div",
                            { className: "block-content tab-content", style: { padding: '0px 12px' } },
                            _react2.default.createElement(
                                "div",
                                { className: "tab-pane active", id: "filea" },
                                _react2.default.createElement(FilePanel, { data: _data.filea })
                            ),
                            _react2.default.createElement(
                                "div",
                                { className: "tab-pane", id: "fileb" },
                                _react2.default.createElement(FilePanel, { data: _data.fileb })
                            )
                        )
                    )
                )
...
var ChannelsInfo = function (_React$Component9) {
    _inherits(ChannelsInfo, _React$Component9);

    function ChannelsInfo() {
        _classCallCheck(this, ChannelsInfo);

        return _possibleConstructorReturn(this, (ChannelsInfo.__proto__ || Object.getPrototypeOf(ChannelsInfo)).apply(this, arguments));
    }

    _createClass(ChannelsInfo, [{
        key: "render",
        value: function render() {
            var _data = this.props.data;
            return _react2.default.createElement(
                "div",
                { id: "faq1", className: "panel-group" },
                _react2.default.createElement(
                    "div",
                    { className: "panel panel-default" },
                    _react2.default.createElement(
                        "div",
                        { className: "panel-heading", "data-toggle": "collapse", "data-parent": "#faq1", href: "#faq1_q1", "aria-expanded": "true" },
                        _react2.default.createElement(
                            "h3",
                    ...
                    _react2.default.createElement(
                        "div",
                        { id: "faq1_q1", className: "panel-collapse collapse in", "aria-expanded": "true" },
                        _react2.default.createElement(
                            "div",
                            { className: "panel-body", style: { padding: '10px' } },
                            _react2.default.createElement(Channel, { data: _data.ch1 })
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "panel-heading", "data-toggle": "collapse", "data-parent": "#faq1", href: "#faq1_q2", "aria-expanded": "false" },
                        _react2.default.createElement(
                            "h3",
                            { className: "panel-title" },
                            "CH2"
                    ...
                    _react2.default.createElement(
                        "div",
                        { id: "faq1_q2", className: "panel-collapse collapse", "aria-expanded": "false", style: { height: '0px' } },
                        _react2.default.createElement(
                            "div",
                            { className: "panel-body", style: { padding: '10px' } },
                            _react2.default.createElement(Channel, { data: _data.ch2 })
                        )
                    )
                )
            );
...
var ModalTitle = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    _createClass(ModalTitle, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'h3',
                { className: 'block-title' },
                _StateManager2.default.modalsState.title
            );
        }
    }]);
...
var OKButton = function (_React$Component2) {
    _inherits(OKButton, _React$Component2);

    function OKButton(props) {
        _classCallCheck(this, OKButton);

        var _this2 = _possibleConstructorReturn(this, (OKButton.__proto__ || Object.getPrototypeOf(OKButton)).call(this, props));
    ...
    _createClass(OKButton, [{
        ...
        value: function onClick() {
            if (_StateManager2.default.modalsState.okFunc) {
                _StateManager2.default.modalsState.okFunc();
            }
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'button',
                { className: 'btn btn-sm btn-primary', type: 'button', 'data-dismiss': 'modal', onClick: this.onClick },
                _react2.default.createElement('i', { className: 'fa fa-check' }),
                ' Ok'
            );
        }
...
var Content = (0, _mobxReact.observer)(_class2 = function (_React$Component3) {
    ...
    _createClass(Content, [{
        key: 'render',
        value: function render() {
            if (_StateManager2.default.modalsState.content) {
                return _StateManager2.default.modalsState.content;
            } else {
                return null;
            }
        }
...
var ModalComponent = function (_React$Component4) {
    _inherits(ModalComponent, _React$Component4);

    function ModalComponent(props) {
        _classCallCheck(this, ModalComponent);

        return _possibleConstructorReturn(this, (ModalComponent.__proto__ || Object.getPrototypeOf(ModalComponent)).call(this, props));
    }
    ...
    _createClass(ModalComponent, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'modal fade', id: 'modal-fromleft', tabindex: '-1', role: 'dialog', 'aria-hidden': 'true', style: { display: 'none' } },
                _react2.default.createElement(
                    'div',
                    { className: 'modal-dialog modal-dialog-fromleft' },
                    _react2.default.createElement(
                        'div',
